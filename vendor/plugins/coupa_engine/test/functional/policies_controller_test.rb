...
class PoliciesControllerTest < Test::Unit::TestCase
  fixtures :roles,:users,:users_roles,:policies
  ...
  def test_show
    ...
    assert_not_nil assigns(:policy)
    assert assigns(:policy).valid?
  end
  ...
  def test_create
    ...
    assert_equal num_policies + 1, Policy.count
  end
